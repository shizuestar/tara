...
<html lang="id">
    <head>
        ...
        <title>TARA – Detail Artikel</title>
    ...
    <body class="relative overflow-x-hidden">
        ...
        <main
            class="w-full pt-32 pb-32 grid grid-cols-1 lg:grid-cols-12 gap-8 px-4">
            ...
            <div class="lg:col-span-8">
                ...
                <section class="hero-wrapper px-4" id="article-hero">
                        ...
                        <div class="uploader-info">
                            ...
                            <div class="text-left leading-tight">
                                <div
                                    ...
                                    class="font-semibold text-[var(--tara-dark)]">
                                    Uploader Contoh
                                </div>
                                <div
                                    id="article-posted-rel"
                    ...
                    <div class="flex flex-col items-center text-center gap-6">
                        <!-- hero image -->
                        <div
                            class="hero-img-wrapper group"
                            id="article-hero-image-wrapper">
                            <img
                        ...
                        <h1
                            id="article-title"
                            class="text-3xl md:text-4xl font-bold max-w-3xl leading-tight"
                            style="font-family: 'Space Grotesk', sans-serif">
                            Judul Artikel
                        </h1>
                        <!-- floating actions -->
                        <div class="float-actions" id="float-actions">
                            ...
                            <div class="relative">
                                ...
                                <span id="float-like-badge" class="badge hidden"
                                    >0</span
                                >
                            </div>
                        </div>
                        <!-- meta -->
                        <div
                            class="flex flex-wrap items-center justify-center gap-4 text-xs text-gray-500">
                            <span id="article-date-meta"
                                ><i class="fas fa-calendar-alt mr-1"></i>–</span
                            >
                            <span id="article-readtime-meta"
                                ><i class="fas fa-book-open mr-1"></i>– menit
                                baca</span
                            >
                            <span id="article-views-meta"
                                ><i class="fas fa-eye mr-1"></i>0 Dilihat</span
                            >
                            <span
                                id="article-category-meta"
                ...
                <section class="max-w-3xl mx-auto mt-10 px-4">
                    <div
                        class="flex flex-wrap gap-2 article-tags"
                        id="article-tags"></div>
                </section>

                <!-- Prev / Next -->
                <nav
                    class="max-w-3xl mx-auto mt-16 px-4 grid grid-cols-1 sm:grid-cols-2 gap-4"
                    id="article-prev-next">
                    <!-- injected -->
                </nav>

                <!-- Recommended -->
                <section
                    class="max-w-6xl mx-auto mt-24 px-4"
                    id="article-reco-wrapper">
                    <h2
                        class="text-2xl md:text-3xl font-bold mb-8 text-center"
                        style="font-family: 'Space Grotesk', sans-serif">
                        Artikel Rekomendasi Lainnya<span
                            class="text-[var(--tara-accent)] ml-1"
                            >●</span
                        >
                    </h2>
                    <div
        ...
        <button id="mobile-comment-toggle">
            <i class="fas fa-comments"></i><span>Komentar</span
            ><span class="count" id="mobile-comment-count">0</span>
        </button>
      ...
      -------------------------------------------------- */
            ...
            <div class='p-4 flex flex-col gap-2'>
                <span class='inline-block px-2 py-1 bg-gray-100 text-xs text-gray-700 rounded-full mb-1'>${
                    a.category.charAt(0).toUpperCase() + a.category.slice(1)
                }</span>
                <h3 class='text-lg font-semibold text-black leading-snug group-hover:underline'>${
                    a.title
                }</h3>
