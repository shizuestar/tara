<aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            <div class="nav-section">
                ...
                <a href="<?php echo e(route('admin.dashboard.index')); ?>" class="nav-item active">
                ...
                <a href="<?php echo e(route('admin.proyek.index')); ?>" class="nav-item">
            ...
            <div class="nav-section">
                ...
                <a href="<?php echo e(route('admin.galeri.index')); ?>" class="nav-item">
            ...
            <div class="nav-section">
                ...
                <a href="<?php echo e(route('admin.settings.index')); ?>" class="nav-item">
    ...
    </aside><?php /**PATH C:\laragon\www\tara\backend\resources\views/components/admin-sidebar.blade.php ENDPATH**/ ?>