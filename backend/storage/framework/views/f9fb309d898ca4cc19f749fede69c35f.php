...
<?php $component->withAttributes([]); ?>
        ...
        <section class="pt-20 pb-20 section-gradient text-center">
            <div class="container">
                <div class="mb-12 mt-20">
                    <h1
                        class="text-5xl md:text-7xl font-bold text-gray-900 inline-flex items-center"
                        style="font-family: 'Space Grotesk', sans-serif"
                    >
                        Proyek & Kolaborasi<span
                            class="text-gray-400 align-middle ml-2 text-3xl"
                            >●</span
                        >
                    </h1>
                    <p
                        class="mt-3 text-lg md:text-xl text-gray-600 leading-relaxed max-w-2xl mx-auto"
                    >
                ...
                <div
                    class="flex flex-col sm:flex-row justify-center gap-4 mb-8"
                >
                    <a href="./buat-kolaborasi" class="create-btn"
                        ><i class="fas fa-plus mr-2"></i> Buat Kolaborasi</a
                    >
                    <a href="./gabung-kolaborasi" class="join-btn"
                        ><i class="fas fa-users mr-2"></i> Gabung Kolaborasi</a
                    >
                </div>
                <div class="flex flex-col sm:flex-row gap-4 mb-8">
                    <div class="flex flex-wrap gap-3 filter-container">
                        ...
                        <button class="filter-btn" data-filter="sastra">
                            Sastra
                        </button>
                        <button class="filter-btn" data-filter="populer">
                            Populer
                        </button>
                    ...
                    <div class="flex gap-3 sort-container">
                        ...
                        <button class="sort-btn" data-sort="members">
                            Anggota
                        </button>
                    </div>
                </div>
                ...
                ></div>
                <div
                    class="text-center mt-10 flex justify-center gap-3"
    ...
    <script>
                ...
                members: [
                    {
                        name: "Budi Santoso",
                        role: "Lead Developer",
                        profileUrl: "/profil/budi",
                        avatar: "https://picsum.photos/100/100?person1",
                    },
                    {
                        name: "Siti Aisyah",
                        role: "UI/UX Designer",
                        profileUrl: "/profil/siti",
                        avatar: "https://picsum.photos/100/100?person2",
                    },
                    {
                        name: "Ahmad Yani",
                        role: "Backend Developer",
                        profileUrl: "/profil/ahmad",
                        avatar: "https://picsum.photos/100/100?person3",
                    },
                    {
                        name: "Rina Putri",
                        role: "Content Creator",
                        profileUrl: "/profil/rina",
                        avatar: "https://picsum.photos/100/100?person4",
                    },
                    {
                        name: "Dewi Lestari",
                        role: "QA Engineer",
                        profileUrl: "/profil/dewi",
                        avatar: "https://picsum.photos/100/100?person5",
                    },
                ],
                description:
                    "Aplikasi interaktif untuk belajar pemrograman dengan cara menyenangkan.",
                ...
                members: [
                    {
                        name: "Andi Pratama",
                        role: "Komposer",
                        profileUrl: "/profil/andi",
                        avatar: "https://picsum.photos/100/100?person6",
                    },
                    {
                        name: "Lina Sari",
                        role: "Vokalis",
                        profileUrl: "/profil/lina",
                        avatar: "https://picsum.photos/100/100?person7",
                    },
                    {
                        name: "Rudi Hartono",
                        role: "Produser",
                        profileUrl: "/profil/rudi",
                        avatar: "https://picsum.photos/100/100?person8",
                    },
                ],
                description:
                    "Album indie dengan perpaduan musik tradisional dan modern.",
                ...
                members: [
                    {
                        ...
                        profileUrl: "/profil/tina",
                        avatar: "https://picsum.photos/100/100?person9",
                    },
                    {
                        name: "Eko Wijaya",
                        role: "Art Director",
                        profileUrl: "/profil/eko",
                        avatar: "https://picsum.photos/100/100?person10",
                    },
                ],
                ...
                members: [
                    {
                        name: "Sari Puspita",
                        role: "Penulis",
                        profileUrl: "/profil/sari",
                        avatar: "https://picsum.photos/100/100?person11",
                    },
                    {
                        name: "Adi Nugroho",
                        role: "Editor",
                        profileUrl: "/profil/adi",
                        avatar: "https://picsum.photos/100/100?person12",
                    },
                    {
                        name: "Lia Amalia",
                        role: "Penulis",
                        profileUrl: "/profil/lia",
                        avatar: "https://picsum.photos/100/100?person13",
                    },
                    {
                        name: "Bima Sakti",
                        role: "Ilustrator",
                        profileUrl: "/profil/bima",
                        avatar: "https://picsum.photos/100/100?person14",
                    },
                ],
                ...
                members: [
                    {
                        name: "Fajar Ramadhan",
                        role: "AI Developer",
                        profileUrl: "/profil/fajar",
                        avatar: "https://picsum.photos/100/100?person15",
                    },
                ],
        ...
        const notifications = [
            {
                id: 1,
                text: "New project update: Aplikasi Edukasi Kode",
                time: "2 jam lalu",
                read: false,
            },
            {
                id: 2,
                text: "New collaboration request: Proyek Musik Kolaborasi",
                time: "4 jam lalu",
                read: false,
            },
        ];
        ...
        function renderProjects(filter = "all", sort = "default", search = "") {
            ...
            let filteredProjects =
                filter === "all"
                    ? projects
                    : filter === "populer"
                    ? projects.filter((p) => p.populer)
                    : filter === "baru"
                    ? projects.filter((p) => p.baru)
            ...
            if (paginatedProjects.length === 0) {
                projectList.innerHTML =
                    '<div class="text-center text-gray-600 col-span-full"><p class="text-lg">Tidak ada proyek ditemukan.</p></div>';
                    ...
                    project.name
                        ...
                        <div class="p-6">
                            <div class="flex items-center mb-3">
                                <h3 class="text-lg font-semibold truncate" style="font-family: 'Space Grotesk', sans-serif;">${
                                    project.name
                                }</h3>
                            </div>
        ...
        function updatePagination(totalProjects) {
            ...
            paginationContainer.innerHTML = `
                ...
                <button class="pagination-btn" data-page="next" ${
                    currentPage === totalPages || totalProjects === 0
                        ? "disabled"
                        : ""
                }><i class="fas fa-chevron-right"></i> Next</button>
            `;
        }
        ...
        function renderNotifications(filter = "all") {
            ...
            if (filteredNotifications.length === 0) {
                notificationList.innerHTML =
                    '<div class="text-center text-gray-600"><p class="text-base">Tidak ada notifikasi.</p></div>';
                updateUnreadCount();
                return;
            }
        ...
        function initParticleAnimation() {
            ...
            function animate() {
                ...
                particles.forEach((particle) => {
                    const waveY =
                        particle.baseY +
                        Math.sin(particle.x * waveFrequency + particle.phase) *
                            waveAmplitude;
        ...
        window.addEventListener("load", () => {
                ...
                .addEventListener("click", (e) => {
                    ...
                    const activeFilter =
                        document.querySelector(".filter-btn.active")?.dataset
                            .filter || "all";
                    const activeSort =
                        document.querySelector(".sort-btn.active")?.dataset
                            .sort || "default";
                    const searchQuery =
            ...
            document
                .querySelector(".notification-modal .close-btn")
                .addEventListener("click", toggleNotifications);
            document
                .querySelector(".notification-modal .close-btn")
                .addEventListener("keypress", (e) => {
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\tara\backend\resources\views/proyek/index.blade.php ENDPATH**/ ?>