    ...
    <main class="main-container">
      ...
      <div class="right-section">
        <div class="w-full max-w-lg p-7 py-20 form-container">
          ...
          <form action="<?php echo e(route('login')); ?>" method="GET" class="space-y-5">
            <input
              type="email"
              placeholder="Email"
...
</html><?php /**PATH C:\xampp\htdocs\lomba\tara\backend\resources\views/public/auth/login.blade.php ENDPATH**/ ?>