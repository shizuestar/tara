            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-6">
                <div class="gallery-item col-span-1 row-span-2" style="--rotate-angle: -2deg; --sway-duration: 6s">
                    <div class="relative h-full overflow-hidden bg-gray-900 border-4 border-gray-200">
                        ...
                        <img src="<?php echo e(asset('assets/img/digitalart.png')); ?>" alt="Digital Art"
                ...
                <div class="gallery-item col-span-1" style="--rotate-angle: 3deg; --sway-duration: 7s">
                    <div class="relative overflow-hidden bg-gray-900 aspect-square border-4 border-gray-200">
                        <img src="<?php echo e(asset('assets/img/photography.png')); ?>" alt="Photography"
                            class="w-full h-full object-cover grayscale hover:grayscale-0 transition-all duration-500" />
                        <div class="image-overlay"></div>
                ...
                <div class="gallery-item col-span-1" style="--rotate-angle: -1deg; --sway-duration: 5.5s">
                    <div class="relative overflow-hidden bg-gray-900 aspect-square border-4 border-gray-200">
                        <img src="<?php echo e(asset('assets/img/ilustration.png')); ?>" alt="Illustration"
                            class="w-full h-full object-cover grayscale hover:grayscale-0 transition-all duration-500" />
                        <div class="image-overlay"></div>
                        <div class="absolute bottom-4 left-4 text-white z-20">
                            <div class="text-sm font-bold uppercase tracking-wide">
                ...
                <div class="gallery-item col-span-2" style="--rotate-angle: 2deg; --sway-duration: 6.5s">
                    <div class="relative overflow-hidden bg-gray-900 aspect-[2/1] border-4 border-gray-200">
                        <img src="<?php echo e(asset('assets/img/creativedesign.png')); ?>" alt="Creative Design"
                            class="w-full h-full object-cover grayscale hover:grayscale-0 transition-all duration-500" />
                        <div class="image-overlay"></div>
                        <div class="absolute bottom-4 left-4 text-white z-20">
                            <div class="text-lg font-bold uppercase tracking-wide">
    ...
    <section class="py-24 px-6 md:px-16 featured-bg relative">
        ...
        <script>
            const galleryData = [{
                    ...
                    author: "Aolon",
                    views: "1200",
                    image: "<?php echo e(asset('assets/img/photography2.png')); ?>",
                ...
                },
                {
                    ...
                    author: "Budi",
                    views: "800",
                    image: "<?php echo e(asset('assets/img/design.png')); ?>",
                ...
                },
                {
                    ...
                    author: "Pandu",
                    views: "1500",
                    image: "<?php echo e(asset('assets/img/uiux.png')); ?>",
                ...
                },
                {
                    ...
                    author: "Dewi",
                    views: "900",
                    image: "<?php echo e(asset('assets/img/coding.png')); ?>",
                ...
                },
                {
                    ...
                    author: "Sari",
                    views: "1100",
                    image: "<?php echo e(asset('assets/img/ilustration.png')); ?>",
                ...
                },
                {
                    ...
                    author: "Joko",
                    views: "1300",
                    image: "<?php echo e(asset('assets/img/photography3.png')); ?>",
                ...
                },
                {
                    ...
                    author: "Pandu",
                    views: "130JT",
                    image: "<?php echo e(asset('assets/img/uiux2.png')); ?>",
                ...
                },
                {
                    ...
                    author: "Joko",
                    views: "1300",
                    image: "<?php echo e(asset('assets/img/coding2.png')); ?>",
            ...
            document.addEventListener("DOMContentLoaded", () => {
                ...
                galleryData.forEach((item) => {
                    ...
                    galleryItem.style.cssText =
                        `--rotate-angle:${item.rotateAngle};--rope-angle:${item.ropeAngle};--sway-duration:${item.swayDuration};`;
...
`;
    ...
    <section id="komunitas" class="py-32 px-6 bg-white relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-4 relative z-10">
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                <div>
                    <h2
                        class="text-6xl md:text-8xl font-bold text-gray-900 mb-10 uppercase tracking-tight text-appear">
        ...
        <div class="max-w-7xl mx-auto relative z-10">
            ...
            <div class="timeline-container">
                ...
                <div class="timeline-item">
                    ...
                    <div class="event-card">
                        <div class="relative">
                            <img src="https://picsum.photos/900/600?random=2" alt="Pameran Seni"
                                class="event-image" />
                            <div class="event-image-overlay"></div>
                ...
                <div class="timeline-item">
                    ...
                    <div class="event-card">
                        <div class="relative">
                            <img src="https://picsum.photos/900/600?random=3" alt="Lomba Kreatif"
                                class="event-image" />
                            <div class="event-image-overlay"></div>
    ...
    <section id="join-now" class="py-32 px-6 relative overflow-hidden section-bg fade-section">
        ...
        <div class="max-w-7xl
            mx-auto relative z-10 text-center">
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\lomba\tara\backend\resources\views/public/main/index.blade.php ENDPATH**/ ?>