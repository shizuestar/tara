<aside class="w-[280px] bg-white border-r border-gray-200 shadow-sm flex flex-col fixed h-screen z-50">
    ...
    <nav class="p-5 flex-grow overflow-y-auto custom-scrollbar">
        <div class="mb-6">
            ...
            <a href="/admin/dashboard" class="nav-item flex items-center py-3 px-6 text-gray-900 font-medium transition-all border-l-4 border-transparent hover:bg-gray-100 hover:border-yellow-400">
            ...
            <a href="/admin/komunitas" class="nav-item flex items-center py-3 px-6 text-gray-900 font-medium transition-all border-l-4 border-transparent hover:bg-gray-100 hover:border-yellow-400">
            ...
            <a href="/admin/proyek" class="nav-item flex items-center py-3 px-6 text-gray-900 font-medium transition-all border-l-4 border-transparent hover:bg-gray-100 hover:border-yellow-400">
            ...
            <a href="/admin/blog" class="nav-item flex items-center py-3 px-6 text-gray-900 font-medium transition-all border-l-4 border-transparent hover:bg-gray-100 hover:border-yellow-400">
        ...
        <div class="mb-6">
            ...
            <a href="/admin/user" class="nav-item flex items-center py-3 px-6 text-gray-900 font-medium transition-all border-l-4 border-transparent hover:bg-gray-100 hover:border-yellow-400">
            ...
            <a href="/admin/galeri" class="nav-item flex items-center py-3 px-6 text-gray-900 font-medium transition-all border-l-4 border-transparent hover:bg-gray-100 hover:border-yellow-400">
    ...
    <div class="p-5 border-t border-gray-200 bg-gray-50">
        <div class="flex items-center gap-3">
            ...
            <a href="/admin/logout" class="w-10 h-10 rounded-lg flex items-center justify-center bg-gray-50 text-gray-900 hover:bg-yellow-400 transition-all">
