...
<html lang="id">
  <head>
    ...
    <style>
      ...
      /* Style untuk mengatasi refresh karena error */
      .form-item.has-error {
          opacity: 1 !important;
  ...
  <body class="bg-gray-50">
    <main class="main-container">
        {{-- BLADE LOGIC: Cek jika ada error validasi --}}
        @php
      ...
      <div class="form-layer {{ $hasErrors ? 'active' : '' }}" id="form-layer" style="opacity: {{ $hasErrors ? '1' : '0' }};">
        ...
        >
          ...
          <form action="{{ route('login') }}" method="POST" class="space-y-5">
            ...
            <div class="form-item {{ $hasErrors ? 'has-error' : '' }}">
              <input
                ...
                value="{{ old('email') }}"
                placeholder="Email"
                class="w-full px-5 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-gray-800 focus:border-gray-900 focus:outline-none text-sm bg-gray-50/70 transition duration-300"
                required
              />
            </div>
            <div class="form-item {{ $hasErrors ? 'has-error' : '' }}">
            ...
            <div class="text-right text-xs form-item {{ $hasErrors ? 'has-error' : '' }}">
              <a
          ...
          <div class="separator form-item {{ $hasErrors ? 'has-error' : '' }}">
          ...
          <div class="grid grid-cols-3 gap-3 text-sm form-item {{ $hasErrors ? 'has-error' : '' }}">
            <button
    ...
    <script>
      ...
      if (hasErrors) {
        startInfiniteScroll(); 
        // Form items sudah diatur untuk langsung tampil melalui class 'has-error' di CSS.
      } else {
        // Animasi Intro Normal
        anime({
          targets: taraLetters,
          translateY: [50, 0],
          translateZ: [0, 100],
      ...
      // Interaksi Hover pada huruf TARA
