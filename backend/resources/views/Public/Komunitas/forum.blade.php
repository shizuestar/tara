    ...
    <script>
        ...
        const communities = [{
            ...
            },
            {
                ...
                category: "Coding",
                description: "Inovasi teknologi dari para developer. Berbagi kode dan Project open-source.",
                members: 450,
        ...
        const communityPosts = [{
            ...
            },
            {
                ...
                content: "<p>Ajak musisi lain untuk Project musik baru, fokus pada genre akustik.</p>",
                time: "3 jam lalu",
                votes: 20,
                pinned: true,
                attachments: [{
            ...
            },
            {
                ...
                content: "<p>Bergabung dalam hackathon untuk Project open-source, fokus pada aplikasi web.</p>",
                time: "5 jam lalu",
                votes: 18,
                pinned: true,
                attachments: [{
            ...
            },
            {
                id: 19,
                communityId: 4,
                title: "Project AI Sederhana",
                content: "<p>Diskusi tentang Project AI untuk pemula.</p>",
                time: "10 jam lalu",
                votes: 15,
                pinned: false,
                attachments: [{
