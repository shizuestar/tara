...
Route::get('/admin/proyek/{id}', [AdminProyekController::class , 'show'])->name('admin.proyek.index');
...
Route::get('/admin/blog/{id}', [AdminBlogController::class , 'show'])->name('admin.blog.detail');
