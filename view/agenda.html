...
<html lang="id">
  ...
  <body class="relative overflow-x-hidden">
        ...
        <div class="space-y-6" id="eventCardsContainer">
          <div class="event-card" data-event-id="1" data-category="painting">
            <div class="card-image-wrapper">
              ...
              />
              <a href="detail_event.html?id=1" class="image-overlay"
                >View Exhibition</a
              >
            </div>
            <div class="card-text">
          ...
          <div class="event-card" data-category="sculpture" data-event-id="2">
            <div class="card-image-wrapper">
              <img
                ...
                onerror="this.src='https://via.placeholder.com/600x400?text=Image+Not+Available'"
              />
              <a href="detail_event.html?id=2" class="image-overlay"
                >View Exhibition</a
              >
            </div>
            <div class="card-text">
          ...
          <div class="event-card" data-category="digital-art" data-event-id="3">
            <div class="card-image-wrapper">
              <img
                ...
                onerror="this.src='https://via.placeholder.com/600x400?text=Image+Not+Available'"
              />
              <a href="detail_event.html?id=3" class="image-overlay"
                >View Exhibition</a
              >
            </div>
            <div class="card-text">
          ...
          <div class="event-card" data-category="photography" data-event-id="4">
            <div class="card-image-wrapper">
              <img
                ...
                onerror="this.src='https://via.placeholder.com/600x400?text=Image+Not+Available'"
              />
              <a href="detail_event.html?id=4" class="image-overlay"
                >View Exhibition</a
              >
            </div>
            <div class="card-text">
          ...
          <div class="event-card" data-category="painting" data-event-id="5">
            <div class="card-image-wrapper">
              <img
                ...
                onerror="this.src='https://via.placeholder.com/600x400?text=Image+Not+Available'"
              />
              <a href="detail_event.html?id=5" class="image-overlay"
                >View Exhibition</a
              >
            </div>
            <div class="card-text">
    ...
    <!-- Footer -->
    <footer
      class="bg-white border-t border-neutral-200 text-sm text-neutral-700"
    >
      <div
        class="max-w-7xl mx-auto px-6 py-16 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-10"
      >
        ...
        <div>
          ...
          <ul class="space-y-2">
            ...
            <li>
              <a href="#" class="hover:text-black transition">GSAP Effects</a>
            </li>
            <li>
              <a href="#" class="hover:text-black transition">Landing Page</a>
            </li>
            <li>
            ...
            <li>
              <a href="#" class="hover:text-black transition">Typography</a>
            </li>
          </ul>
        </div>
        <div>
          ...
          <ul class="space-y-2">
            <li>
              <a href="#" class="hover:text-black transition">Submit Karya</a>
            </li>
            <li>
              <a href="#" class="hover:text-black transition">Gabung Kurator</a>
            </li>
            <li>
              <a href="#" class="hover:text-black transition"
                >Sponsor & Iklan</a
            ...
            <li>
              <a href="#" class="hover:text-black transition">Media Partner</a>
            </li>
          </ul>
        </div>
      ...
      <div
        class="border-t border-neutral-200 text-center py-4 text-xs text-neutral-400"
      >
    ...
    <div id="eventModal" class="fixed inset-0 hidden">
      <div class="modal-content">
        <div class="flex justify-end">
          <button
            id="closeModalBtn"
            class="text-black hover:text-black transform hover:scale-110 transition"
        ...
        <div id="modalContent" class="text-left">
          ...
          <h2
            id="modalTitle"
            class="text-xl font-bold font-['Space Grotesk'] mb-3 text-gradient"
          ></h2>
